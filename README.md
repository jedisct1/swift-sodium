...
It targets Swift 4.2, introduced in Xcode 10.
...
Running these scripts on Xcode 10.2 beta (`10P82s`) on the revision `7d418f8203897a967cce3dc0dcf8925f894e3428` of libsodium generates files identical to the ones present in this repository.

The `libsodium-watchOS.a` file has been generated by the
[dist-build/watchOS.sh](https://github.com/jedisct1/libsodium/blob/86fbbd853f6131ce8b4ed454c7259a0b2319bdac/dist-build/watchOS.sh)
script.

Running this script on Xcode 10.0 (`10A255`) on the revision `86fbbd853f6131ce8b4ed454c7259a0b2319bdac` of libsodium generates files identical to the ones present in this repository.
