...
Running these scripts on Xcode 9.2 (`9C40b`) on the revision `5ebc0d40295ac6c509aaf1d3ed5ded6bc2a77074` of libsodium generates files identical to the ones present in this repository.
