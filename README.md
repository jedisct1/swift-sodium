...
It targets Swift 4.2, introduced in Xcode 10.0.
...
Running these scripts on Xcode 10.0 (`10A255`) on the revision `1dae690ad7b6a6b7aecb951360528575577de185` of libsodium generates files identical to the ones present in this repository.
