...
Running this script on Xcode 12.0 beta 4 (`12A8179i`) on the revision `fe1f789809a634f3014f0984b4308ee0bfa3cb10` of libsodium generates files identical to the ones present in this repository.
