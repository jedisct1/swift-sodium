...
Running this script on Xcode 14.1 (`14B47b`) on the revision `c4b1c04c02230bcac54f58478ef308caf4be8e73` of libsodium generates files identical to the ones present in this repository.
